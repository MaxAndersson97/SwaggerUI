...
namespace Swagger.Services
{
    public class ProductWareHouseService
    {
        ...
        public ProductWareHouseService(IConfiguration configuration)
        {
            ...
            _collection = database.GetCollection<ProductWareHouse>("ProductWareHouse");
        }
        ...
        public List<ProductWareHouse> getProductByWareHouse(string warehouseId)
        {
            return _collection.Find(ProductWareHouse => ProductWareHouse.warehouse_id == warehouseId).ToList();
        }
